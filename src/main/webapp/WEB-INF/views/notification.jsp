...
<div class="notification_title"><h2>2012年10-11月份公司宣传通讯稿执行情况通报</h2></div>
<div class="notification_context">
	<div class="context">
		<div class="top">
			&nbsp;&nbsp;&nbsp;&nbsp;截止2012年10月31日（星期三），各职能部门通迅报道供稿情况通报如下:
		</div>
		<div class="middle">
			<table>
				<tr>
				...
				<tr>
					<td>技术部</td><td>1</td><td>0</td><td>0</td><td></td>
				</tr>
				<tr>
					<td>成本管理部</td><td>1</td><td>0</td><td>0</td><td></td>
				</tr>
				<tr>
					<td>销售部</td><td>2</td><td>1</td><td>1</td><td>完成</td>
				</tr>
				<tr>
					<td>采购部</td><td>1</td><td>2</td><td>1</td><td>完成</td>
				</tr>
				<tr>
					<td>财务部</td><td>1</td><td>1</td><td>0</td><td>完成</td>
				</tr>
				<tr>
					<td>办公室</td><td>4</td><td>3</td><td>2</td><td>完成</td>
				</tr>
				<tr>
					<td colspan="4">月度优秀通讯员</td><td>采购部:倪荷君<br/>办公室:全小锋</td>
				</tr>
			</table>
		</div>
		<div class="bottom">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（三）语句通顺流畅，内容健康上进。
			<br/>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;为表彰优秀，鼓励更多员工继续创作好作品，促进《通讯稿考核管理办法》进一步实施，公司经研究决定，除集团《方远报》编辑部发放稿费外，额外给予优秀通讯员奖励电影票2张，今后公司还将采取多种形式奖励优秀通讯员。
		</div>
		<div class="company">
