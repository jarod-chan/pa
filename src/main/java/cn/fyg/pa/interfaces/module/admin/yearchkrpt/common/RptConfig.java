...
public class RptConfig {
	...
	public static PointHelp<?>  getPointHelp(Long year){
		if(year==2013L){
			return new cn.fyg.pa.interfaces.module.admin.yearchkrpt.year2013.PointUtil();
		}else if(year==2012L){
			return new cn.fyg.pa.interfaces.module.admin.yearchkrpt.year2012.PointUtil();
		}else if(year==2011L){
			return new cn.fyg.pa.interfaces.module.admin.yearchkrpt.year2011.PointUtil();
		}
		return null;
	}
